      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          <a
            ...
            className="flex items-center justify-center w-10 h-10 rounded-full border border-[#E2D2C2] text-[#674433] hover:text-[#3B271E] hover:border-[#DCA028] hover:bg-[#FDF9F3] transition-all"
